...
@interface mgRequestPauseLecVC_iPad ()
{
...
@implementation mgRequestPauseLecVC_iPad
...
- (void)showPicker:(NSString*)title
{
    ...
    [_vPickerBG setFrame:CGRectMake(0 , 231, 320, 260)];
...
- (void)hidePicker
{
    ...
    [_vPickerBG setFrame:CGRectMake(0 , 231+260, 320, 260)];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection{
    ...
    }else if(connection == _connRequest)
    {
        ...
        if ([[dic valueForKey:@"result"]isEqualToString:@"0000"]) {
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:@"ReloadLecList" object:self._LecInfo];
