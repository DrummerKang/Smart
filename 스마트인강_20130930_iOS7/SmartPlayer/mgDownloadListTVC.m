...
@implementation mgDownloadListTVC
...
- (void)viewDidLoad{
    ...
    if (badge == nil) {
        ...
        [downNavigationBar addSubview:badge];
        [self setBadge];
    }
...
- (void)loadData{
    ...
    //NSMutableArray *arr = (NSMutableArray *)[[AquaDBManager sharedManager] selectAllContent];
...
- (void)editMethod{
    ...
    if([mgCommon osVersion_7]){
        editBtn.frame = CGRectMake(255, 27, 60, 30);
    }else {
        editBtn.frame = CGRectMake(255, 7, 60, 30);
    }
    
    [editBtn addTarget:self action:@selector(completeAction) forControlEvents:UIControlEventTouchUpInside];
...
- (void)completeAction{
    ...
    [completeBtn addTarget:self action:@selector(editAction) forControlEvents:UIControlEventTouchUpInside];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    NSMutableArray *_arr = (NSMutableArray*)[[_marrData objectAtIndex:section]objectForKey:@"lecData"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    UIView *_customView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 320, 88)];
    
    //배경
    UIImageView *bgImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 320, 86)];
    bgImage.image = [UIImage imageNamed:@"con_box"];
    [_customView addSubview:bgImage];
    
    //배경라인 위
    UIImageView *bgLine = [[UIImageView alloc] initWithFrame:CGRectMake(0, -1, 320, 2)];
    bgLine.image = [UIImage imageNamed:@"line_blue"];
    [_customView addSubview:bgLine];
    
    //배경라인 밑
    UIImageView *bgLineDown = [[UIImageView alloc] initWithFrame:CGRectMake(0, 87, 320, 1)];
    bgLineDown.image = [UIImage imageNamed:@"cellList"];
    [_customView addSubview:bgLineDown];
    
    //선생님 이미지
    UIImageView *photoImage = [[UIImageView alloc] initWithFrame:CGRectMake(17, 17, 52, 52)];
    ...
    //과목이미지
    UIImageView *subjectImage = [[UIImageView alloc] initWithFrame:CGRectMake(6, 6, 41, 41)];
    ...
    //선생님 이름
    UILabel *teacherName = [[UILabel alloc]initWithFrame:CGRectMake(79, 21, 280, 15)];
    ...
    //강좌제목
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(79, 40, 230, 20)];
...
- (void) playMovie:(NSString*)urlString{
	...
	controlViewController = [[PlayerControlDownViewController alloc] initWithNibName:@"PlayerControlDownViewController" bundle:nil];
