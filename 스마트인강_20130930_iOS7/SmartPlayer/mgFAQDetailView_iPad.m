...
@implementation mgFAQDetailView_iPad
...
- (id)initWithData:(NSDictionary *)dicData {
    if (self = [super init]) {
        ...
        NSString *webURL = [[NSString alloc]initWithFormat:@"%@%@?fidx=%@", URL_DOMAIN, URL_FAQ_DETAIL, [dicData valueForKey:@"fidx"]];
