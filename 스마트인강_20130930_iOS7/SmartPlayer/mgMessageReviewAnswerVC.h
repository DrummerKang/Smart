...
@interface mgMessageReviewAnswerVC : mgUIControllerCommon<UIActionSheetDelegate, NSURLConnectionDataDelegate, NSURLConnectionDelegate, UIWebViewDelegate>{
    NSString *timeStr;
    NSString *contentStr;
}

@property (strong, nonatomic) IBOutlet UINavigationBar *answerNavigationBar;
